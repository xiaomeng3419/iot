<template>
    <div class="dialog" v-show="showMask">
        <div class="dialog-container">
            <div class="dialog-title"><span class="span-img"><img class='tip-img' src='../../css/images/warn.png'></span>{{title}}</div>
            <hr style="height:10px;border:none;border-top:10px groove #EF8C8C;" />
            <div class="content alert alert-danger" v-html="content" role="alert"></div>
            <div class="btns">
